        ...
        <div className="flex flex-col items-center justify-center min-h-screen sm:m-auto">
            <div className="bg-white px-36 py-10 rounded-lg drop-shadow-[0_1.2px_1.2px_rgba(99,94,255,0.542)]">
                <div className="justify-center">
                    <h1 className="text-4xl text-indigo-500 font-bold text-center">Create an account</h1>
                    <h2 className="texl-3xl text-indigo-400 font-bold text-center">Required fields are marked with an asterisk (*)</h2>
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-2">
                                ...
                                <div className="flex items-center justify-between">
                                    <label htmlFor="password" className="text-indigo-500 font-bold">*Password:</label>
                            ...
                            <div className="mt-2">
                                <label htmlFor="confirm-password" className="text-indigo-500 font-bold">*Confirm Password:</label>
                                <input
                                    className="w-full px-2 py-1 mt-1 border rounded-md outline outline-2 outline-indigo-300 focus:outline-indigo-700"
                                    type="password"
                                    id="confirm-password"
                    ...
                    <div className="flex gap-2 justify-center text-center mt-3">
                        <p className="text-indigo-400 font-bold">Already have an account?</p>
